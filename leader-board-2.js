      ...
      if( result[targetName].length > 0 ) {
        $.each(result[targetName], function(personIndex, personInfo) {
          ...
          if(userCase == 'up') {
            ...
            userCaseImg = "https://uploads-ssl.webflow.com/62b29aa34123680c6480de24/63f74d44853c14449e2b3214_Brown%20Bar.svg";
          } else {
            userCaseImg = "https://uploads-ssl.webflow.com/62b29aa34123680c6480de24/63dcf0941bb0b71f28edec6d_Green-arrow.svg";
          }
          ...
          } else if(rankingNumber > 3 && rankingNumber < 9) { // 20-2 - new changes
            output2 += `
        ...
        $( '.perks-leader-output-2.' + time ).html(output3);  // 20-2 - new changes
